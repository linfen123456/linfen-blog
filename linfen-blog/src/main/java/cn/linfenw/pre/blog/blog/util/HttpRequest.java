package cn.linfenw.pre.blog.blog.util;
...
public class HttpRequest {
    ...
    public static void main(String[] args) {
        ...
        String s=HttpRequest.sendGet("https://api.ixiaowai.cn/api/api.php?return=json", "");
      ...
      /*  //发送 POST 请求
        ...
        Map<String,String> json = JSONObject.parseObject(sr, HashMap.class);
